      ...
      <div className="relative p-4 w-full max-w-4xl max-h-full">
        ...
        <div className="relative rounded-lg shadow bg-[#f4f4f4]">
          ...
          <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-600">
            <div className="flex flex-col gap-y-2 md:gap-y-0 md:flex-row gap-x-5">
              {/* mobile cross */}
              ...
              {/* block 1 */}
              <div className="flex flex-col md:w-[350px] bg-white p-3 rounded-md">
              ...
              {/* block 2 */}
              <div className="flex flex-col md:w-[420px] bg-white p-3 rounded-md">
                <div className="flex flex-row gap-x-3">
                  <div className="w-[50%]">
                ...
                <div className="flex flex-row gap-x-3">
                  <div className="w-[50%]">Tracking No</div>
                  <div className="w-[50%] ">: ord-05-2004</div>
                </div>
              </div>
          ...
          {/* Modal body */}
          <div className="flex flex-col justify-center items-center p-2 md:p-5 space-y-4">
            <div className="md:w-[800px] bg-white mt-5 lg:mt-0 md:mx-[20%]">
              {/* <h2 className="text-xl font-bold mb-8">Your Order</h2> */}
              <div className="rounded-lg text-black my-2 py-5">
                <div className="flex mb-5 ml-3 md:ml-[8%]">
                  <h1 className="md:text-lg">Product</h1>
                </div>
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex flex-col">
                    <div className="flex justify-center mb-5">
                      <h1 className="md:text-lg ">Overview</h1>
                    </div>
          ...
          <div className="flex justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button
              type="button"
              className="text-white w-[120px] bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
            >
              Close
            </button>
          </div>
