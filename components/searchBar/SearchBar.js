      ...
      <form className="mx-auto md:max-lg:w-[250px] lg:w-[500px] md:h-[40px]">
        <div className="flex justify-center">
          <div className="relative w-full">
            ...
            <button
              type="submit"
              className="absolute top-0 end-0 lg:p-2.5 md:max-lg:w-[25%] lg:w-[20%] text-white md:max-lg:text-xs lg:text-sm font-medium h-full bg-blue-700 rounded-e-2xl border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              <p>Search</p>
            </button>
          </div>
